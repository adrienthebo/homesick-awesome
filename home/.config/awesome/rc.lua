...
globalkeys = awful.util.table.join(
    ...
    -- Screen brightness
    awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn("xbacklight -time 100 -dec 10") end),
    awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn("xbacklight -time 100 -inc 10") end),
...
awful.rules.rules = {
    ...
    -- Google hangouts running under Chrome
...
client.connect_signal("focus", function(c) c.border_color = "#00a060" end)
